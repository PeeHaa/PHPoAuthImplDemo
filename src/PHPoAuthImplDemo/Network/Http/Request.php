 ...
 * @version    1.0.0
 */
namespace PHPoAuthImplDemo\Network\Http;

use PHPoAuthImplDemo\Storage\ImmutableKeyValue;
...
{
    /**
     * @var \PHPoAuthImplDemo\Storage\ImmutableKeyValue The path variables
     */
    private $pathVariables;

    /**
     * @var \PHPoAuthImplDemo\Storage\ImmutableKeyValue The GET variables
     */
    private $getVariables;

    /**
     * @var \PHPoAuthImplDemo\Storage\ImmutableKeyValue The POST variables
     */
    private $postVariables;

    /**
     * @var \PHPoAuthImplDemo\Storage\ImmutableKeyValue The SERVER variables
     */
    private $serverVariables;

    /**
     * @var \PHPoAuthImplDemo\Storage\ImmutableKeyValue The FILES variables
     */
    private $filesVariables;

    /**
     * @var \PHPoAuthImplDemo\Storage\ImmutableKeyValue The COOKIES variables
     */
    private $cookies;
     ...
     * Creates instance
     *
     * @param \PHPoAuthImplDemo\Storage\ImmutableKeyValue $pathVariables   The path variables
     * @param \PHPoAuthImplDemo\Storage\ImmutableKeyValue $getVariables    The GET variables
     * @param \PHPoAuthImplDemo\Storage\ImmutableKeyValue $postVariables   The POST variables
     * @param \PHPoAuthImplDemo\Storage\ImmutableKeyValue $serverVariables The SERVER variables
     * @param \PHPoAuthImplDemo\Storage\ImmutableKeyValue $filesVariables  The FILES variables
     * @param \PHPoAuthImplDemo\Storage\ImmutableKeyValue $cookies         The COOKIE variables
     */
